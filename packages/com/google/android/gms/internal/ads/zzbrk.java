...
public final class zzbrk implements zzelo<zzbys<zzbwt>> {
    ...
    private zzbrk(zzelx<zzckw> zzelxVar, zzelx<Executor> zzelxVar2) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
    }

    public static zzbrk zzs(zzelx<zzckw> zzelxVar, zzelx<Executor> zzelxVar2) {
        return new zzbrk(zzelxVar, zzelxVar2);
    }
