...
public final class zzcju implements zzelo<zzbys<zzbtm>> {
    ...
    private zzcju(zzelx<zzckb> zzelxVar, zzelx<Executor> zzelxVar2) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
    }

    public static zzcju zzac(zzelx<zzckb> zzelxVar, zzelx<Executor> zzelxVar2) {
        return new zzcju(zzelxVar, zzelxVar2);
    }
