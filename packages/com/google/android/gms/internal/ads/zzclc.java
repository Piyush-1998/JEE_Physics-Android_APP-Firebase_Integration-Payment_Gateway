...
public final class zzclc implements zzelo<zzbys<zzbuj>> {
    ...
    private zzclc(zzelx<zzcky> zzelxVar, zzelx<Executor> zzelxVar2) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
    }

    public static zzclc zzam(zzelx<zzcky> zzelxVar, zzelx<Executor> zzelxVar2) {
        return new zzclc(zzelxVar, zzelxVar2);
    }
