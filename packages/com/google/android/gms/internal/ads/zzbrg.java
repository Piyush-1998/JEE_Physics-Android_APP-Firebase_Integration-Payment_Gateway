...
public final class zzbrg implements zzelo<zzbys<zzbtm>> {
    ...
    private zzbrg(zzelx<zzbvi> zzelxVar, zzelx<Executor> zzelxVar2) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
    }

    public static zzbrg zzp(zzelx<zzbvi> zzelxVar, zzelx<Executor> zzelxVar2) {
        return new zzbrg(zzelxVar, zzelxVar2);
    }
