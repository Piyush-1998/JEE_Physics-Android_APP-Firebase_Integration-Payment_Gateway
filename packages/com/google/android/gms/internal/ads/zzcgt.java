...
public final class zzcgt implements zzelo<zzcgu> {
    ...
    private zzcgt(zzelx<String> zzelxVar, zzelx<zzcco> zzelxVar2, zzelx<zzccv> zzelxVar3) {
        this.zzfsn = zzelxVar;
        this.zzgcf = zzelxVar2;
        this.zzfwo = zzelxVar3;
    }

    public static zzcgt zzl(zzelx<String> zzelxVar, zzelx<zzcco> zzelxVar2, zzelx<zzccv> zzelxVar3) {
        return new zzcgt(zzelxVar, zzelxVar2, zzelxVar3);
    }
