...
public final class zzbrh implements zzelo<zzbys<zzbuy>> {
    ...
    private zzbrh(zzelx<zzbvi> zzelxVar, zzelx<Executor> zzelxVar2) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
    }

    public static zzbrh zzq(zzelx<zzbvi> zzelxVar, zzelx<Executor> zzelxVar2) {
        return new zzbrh(zzelxVar, zzelxVar2);
    }
