...
public final class zzclb implements zzelo<zzbys<zzdpl>> {
    ...
    private zzclb(zzelx<zzclm> zzelxVar, zzelx<Executor> zzelxVar2) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
    }

    public static zzclb zzal(zzelx<zzclm> zzelxVar, zzelx<Executor> zzelxVar2) {
        return new zzclb(zzelxVar, zzelxVar2);
    }
