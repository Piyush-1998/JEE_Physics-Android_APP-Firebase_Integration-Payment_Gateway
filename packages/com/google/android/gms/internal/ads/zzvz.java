...
public final class zzvz extends zzwf<zzwu> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzvz(zzvr zzvrVar, Context context, zzvj zzvjVar, String str, zzamu zzamuVar) {
        this.zzchz = zzvrVar;
    ...
    public final /* synthetic */ zzwu zzpo() throws RemoteException {
        ...
        return zzvaVar.zza(this.val$context, this.zzchw, this.zzchx, this.zzchy, 2);
    }

    @Override // com.google.android.gms.internal.ads.zzwf
    public final /* synthetic */ zzwu zza(zzxh zzxhVar) throws RemoteException {
        return zzxhVar.zzb(ObjectWrapper.wrap(this.val$context), this.zzchw, this.zzchx, this.zzchy, 202006000);
    }
}
