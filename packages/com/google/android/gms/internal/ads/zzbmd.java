...
public final class zzbmd implements zzelo<Set<zzbys<zzbtm>>> {
    ...
    private zzbmd(zzelx<zzbma> zzelxVar, zzelx<Executor> zzelxVar2, zzelx<JSONObject> zzelxVar3) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
        this.zzfmy = zzelxVar3;
    }

    public static zzbmd zza(zzelx<zzbma> zzelxVar, zzelx<Executor> zzelxVar2, zzelx<JSONObject> zzelxVar3) {
        return new zzbmd(zzelxVar, zzelxVar2, zzelxVar3);
    }
