...
interface zzekk {
    ...
    void zza(int i, zzeff zzeffVar) throws IOException;

    <K, V> void zza(int i, zzehu<K, V> zzehuVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj, zzeiv zzeivVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzeiv zzeivVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzeiv zzeivVar) throws IOException;

    void zzb(int i, List<zzeff> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzeiv zzeivVar) throws IOException;
