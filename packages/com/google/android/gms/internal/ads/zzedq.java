...
public final class zzedq {
    ...
    public static ECParameterSpec zza(zzeds zzedsVar) throws NoSuchAlgorithmException {
        int i = zzedp.zzhzc[zzedsVar.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                ...
                String valueOf = String.valueOf(zzedsVar);
    ...
    public static ECPublicKey zza(zzeds zzedsVar, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec zza = zza(zzedsVar);
