...
public final class zzza extends ContentProvider {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (str != null && !str.matches("^/\\d+~.+$")) {
                                ...
                                zzbbd.zzef(valueOf.length() != 0 ? "Publisher provided Google AdMob App ID in manifest: ".concat(valueOf) : new String("Publisher provided Google AdMob App ID in manifest: "));
                                ...
                                zzbbd.zzef(valueOf2.length() != 0 ? "The Google Mobile Ads SDK is integrated by ".concat(valueOf2) : new String("The Google Mobile Ads SDK is integrated by "));
                            } else {
    ...
    private static Bundle zzh(Context context) {
        try {
            ...
            zzbbd.zzc("Failed to load metadata: Package name not found.", e);
            return null;
        } catch (NullPointerException e2) {
            zzbbd.zzc("Failed to load metadata: Null pointer exception.", e2);
            return null;
        }
    }
}
