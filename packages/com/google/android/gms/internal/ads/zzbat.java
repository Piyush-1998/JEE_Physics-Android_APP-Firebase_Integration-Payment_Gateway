...
public final class zzbat {
    ...
    public final int zzb(Context context, int i) {
        ...
        return Math.round(i / this.zzedi);
    }
    ...
    public final void zza(ViewGroup viewGroup, zzvj zzvjVar, String str, String str2) {
        zzbbd.zzfe(str2);
        zza(viewGroup, zzvjVar, str, SupportMenu.CATEGORY_MASK, ViewCompat.MEASURED_STATE_MASK);
    }

    public final void zza(ViewGroup viewGroup, zzvj zzvjVar, String str) {
        zza(viewGroup, zzvjVar, str, ViewCompat.MEASURED_STATE_MASK, -1);
    }

    private final void zza(ViewGroup viewGroup, zzvj zzvjVar, String str, int i, int i2) {
        ...
        frameLayout.addView(textView, new FrameLayout.LayoutParams(zzvjVar.widthPixels - zzc, zzvjVar.heightPixels - zzc, 17));
        viewGroup.addView(frameLayout, zzvjVar.widthPixels, zzvjVar.heightPixels);
    }

    public static String zzbm(Context context) {
        ContentResolver contentResolver = context.getContentResolver();
        return zzex(((contentResolver == null ? null : Settings.Secure.getString(contentResolver, "android_id")) == null || zzym()) ? "emulator" : "emulator");
    }
    ...
    public static String zza(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        while (true) {
            ...
            i = ("loadAd".equalsIgnoreCase(stackTraceElement.getMethodName()) && (zzedc.equalsIgnoreCase(className) || zzedd.equalsIgnoreCase(className) || zzede.equalsIgnoreCase(className) || zzedf.equalsIgnoreCase(className) || zzedg.equalsIgnoreCase(className) || zzedh.equalsIgnoreCase(className))) ? 0 : i2;
        }
    ...
    public static void zza(Context context, String str, String str2, Bundle bundle, boolean z, zzbau zzbauVar) {
        ...
        zzbauVar.zzes(appendQueryParameter.toString());
    }
