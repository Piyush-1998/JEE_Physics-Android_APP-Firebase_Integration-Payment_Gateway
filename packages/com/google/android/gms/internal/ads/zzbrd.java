...
public final class zzbrd implements zzelo<zzbys<zzbti>> {
    ...
    private zzbrd(zzelx<zzbvi> zzelxVar, zzelx<Executor> zzelxVar2) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
    }

    public static zzbrd zzm(zzelx<zzbvi> zzelxVar, zzelx<Executor> zzelxVar2) {
        return new zzbrd(zzelxVar, zzelxVar2);
    }
