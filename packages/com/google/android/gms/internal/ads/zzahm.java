...
public final class zzahm {
    ...
    public zzahm(Context context, zzeg zzegVar, View view) {
        this.zzvr = context;
        this.zzbpg = zzegVar;
        this.view = view;
    }
    ...
    private final ResolveInfo zza(Intent intent, ArrayList<ResolveInfo> arrayList) {
        ...
        try {
            packageManager = this.zzvr.getPackageManager();
        } catch (Throwable th) {
            com.google.android.gms.ads.internal.zzp.zzkt().zza(th, "OpenSystemBrowserHandler.getDefaultBrowserResolverForIntent");
        }
