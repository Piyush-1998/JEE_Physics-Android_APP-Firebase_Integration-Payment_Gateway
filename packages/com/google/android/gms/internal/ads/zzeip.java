...
public interface zzeip {
    ...
    <T> T zza(zzeiv<T> zzeivVar, zzegc zzegcVar) throws IOException;

    <T> void zza(List<T> list, zzeiv<T> zzeivVar, zzegc zzegcVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzehu<K, V> zzehuVar, zzegc zzegcVar) throws IOException;

    @Deprecated
    <T> T zzb(zzeiv<T> zzeivVar, zzegc zzegcVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzeiv<T> zzeivVar, zzegc zzegcVar) throws IOException;
