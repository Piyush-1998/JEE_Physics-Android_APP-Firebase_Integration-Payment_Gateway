...
public final class zzbrj implements zzelo<zzbys<zzbtm>> {
    ...
    private zzbrj(zzelx<zzckw> zzelxVar, zzelx<Executor> zzelxVar2) {
        this.zzfmx = zzelxVar;
        this.zzerr = zzelxVar2;
    }

    public static zzbrj zzr(zzelx<zzckw> zzelxVar, zzelx<Executor> zzelxVar2) {
        return new zzbrj(zzelxVar, zzelxVar2);
    }
