...
public class AdLoader {
    ...
    public static class Builder {
        ...
        private Builder(Context context, zzwr zzwrVar) {
            this.zzvr = context;
            this.zzacr = zzwrVar;
        }
        ...
        public Builder forCustomTemplateAd(String str, NativeCustomTemplateAd.OnCustomTemplateAdLoadedListener onCustomTemplateAdLoadedListener, NativeCustomTemplateAd.OnCustomClickListener onCustomClickListener) {
            ...
            try {
                this.zzacr.zza(str, zzagcVar.zzst(), zzagcVar.zzsu());
            } catch (RemoteException e) {
    ...
    AdLoader(Context context, zzwm zzwmVar) {
        this(context, zzwmVar, zzvh.zzchm);
    }

    private AdLoader(Context context, zzwm zzwmVar, zzvh zzvhVar) {
        this.zzvr = context;
        this.zzact = zzwmVar;
        this.zzacs = zzvhVar;
    }
